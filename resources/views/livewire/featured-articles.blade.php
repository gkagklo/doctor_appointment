...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
        <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white" id="articles">Featured Articles</h2>
      </div>
      <!-- End Title -->
    <!-- Grid -->
      ...
      <a class="group sm:flex rounded-xl focus:outline-none" href="#">
        ...
        <div class="grow">
          <div class="p-4 flex flex-col h-full sm:p-6">
            ...
            <h3 class="text-lg sm:text-2xl font-semibold text-gray-800 group-hover:text-blue-600 group-focus:text-blue-600 dark:text-neutral-300 dark:group-hover:text-white dark:group-focus:text-white">
        ...
        <div class="grow">
          <div class="p-4 flex flex-col h-full sm:p-6">
            ...
            <div class="mt-5 sm:mt-auto">
              ...
              <div class="flex items-center">
                <div class="shrink-0">
                  <img class="size-[46px] rounded-full" src="https://images.unsplash.com/photo-1669720229052-89cda125fc3f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80" alt="Avatar">
                </div>
                <div class="ms-2.5 sm:ms-4">
                  <h4 class="font-semibold text-gray-800 dark:text-neutral-200">
                    Hanna Wolfe
