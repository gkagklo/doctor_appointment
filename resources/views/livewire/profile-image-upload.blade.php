<section>
    ...
    <form wire:submit="save" class="mt-6 space-y-6">
        <div> 
            ...
            @else
            <img class="inline-block size-[62px] rounded-full" src="{{ Storage::url(auth()->user()->profile_image)}}" alt="Avatar">
            @endif
            <x-input-label for="profile_image" :value="__('Profile Image')" />
                <input wire:model="profile_image" type="file" name="profile_image" id="profile_image" class="block w-full border border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400
